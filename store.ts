...
const getPersistedLang = (): Language => {
  ...
  // Changed default to English as requested
  return 'en';
};

// Initial Room State
// Names here are fallback/internal IDs mostly, UI will override based on translation
const defaultRooms: Record<string, RoomConfig> = {
    'public-world': {
        id: 'public-world', name: 'Nature World', description: 'Green grass, blue sky.',
        type: 'nature', isPrivate: false, isOfficial: true,
    ...
    'public-night': {
        id: 'public-night', name: 'Lunar Night', description: 'Dark sky, snow, moon.',
        type: 'space', isPrivate: false, isOfficial: true,
        rules: { allowScreenShare: true, forbidMicMute: false, preventIgnoring: false },
        maxPlayers: 50, currentPlayers: 0, allowedReactions: DEFAULT_REACTIONS,
        subscribers: [], createdAt: Date.now()
    },
    'public-room8': {
        id: 'public-room8', name: 'Room8 Office', description: 'Classic meeting room.',
        type: 'minimal', isPrivate: false, isOfficial: true,
        rules: { allowScreenShare: true, forbidMicMute: false, preventIgnoring: false },
        maxPlayers: 20, currentPlayers: 0, allowedReactions: DEFAULT_REACTIONS,
        subscribers: [], createdAt: Date.now()
    }
};
