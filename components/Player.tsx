...
export const LocalPlayer = () => {
  ...
  useFrame((state) => {
    ...
    if (isJoystickActive && group.current) {
        // Updated Camera Position: LOWER (1.2) and slightly closer (5)
        // This puts the camera very low to the ground.
        ...
        // Updated LookAt: Look HIGHER (y + 2.2)
        // Combined with low camera, this creates the "Bottom-Up" tilt.
        state.camera.lookAt(group.current.position.x, group.current.position.y + 2.2, group.current.position.z);
    } 
