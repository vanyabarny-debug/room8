...
export type EnvironmentType = 'day' | 'night' | 'office' | 'roofs' | 'amphitheater' | 'lobby' | 'conference' | 'call';
...
export interface PlayerState extends PlayerConfig {
  ...
  isSpeaking: boolean;
  isMicOn: boolean;
  isVideoOn: boolean; // New: Camera state
  ...
  // Interaction
  isSitting?: boolean;
  isSpeaker?: boolean; // New: Loud mode for conference
